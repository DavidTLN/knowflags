...
export default function SubFlagQuiz() {
  ...
  if (loading) return (
    <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#F4F1E6' }}>
      <p style={{ color: '#0B1F3B', fontSize: '18px', fontWeight: '700' }}>{t('Loading…', 'Chargement…')}</p>
    </div>
  )
  ...
  if (questions.length < 4) return (
    <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#F4F1E6', flexDirection: 'column', gap: '16px', padding: '24px', textAlign: 'center' }}>
      ...
      <p style={{ color: '#0B1F3B', fontSize: '18px', fontWeight: '700' }}>
  ...
  if (phase === 'intro') return (
    <div style={{ minHeight: '100vh', backgroundColor: '#F4F1E6', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div style={{ maxWidth: '480px', width: '100%', textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: '32px', fontWeight: '900', color: '#0B1F3B', margin: '0 0 12px' }}>SubFlag Quiz</h1>
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#F4F1E6', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', gap: '24px' }}>
        ...
        {phase === 'result' && (
          <button onClick={nextQuestion} style={{ width: '100%', maxWidth: '480px', padding: '16px', backgroundColor: '#0B1F3B', color: 'white', border: 'none', borderRadius: '12px', fontSize: '16px', fontWeight: '800', cursor: 'pointer' }}>
